        ...
        <div className="relative">
            <EditorTooltip content="Text Style">
                <button
                    ...
                    className={cn(
                        ...
                        "focus-visible:ring-1 focus-visible:ring-(--color-ring) focus-visible:outline-none",
                ...
                >
                    ...
                    <span className="hidden w-16 truncate text-left sm:inline">
            ...
            {open && (
                <>
                    ...
                    />
                    <div className="absolute top-full left-0 z-50 mt-1 min-w-40 rounded-lg border border-(--color-border) bg-(--color-background) p-1 shadow-lg">
                        {headings.map((h) => (
                            <button
                                key={h.level}
                                type="button"
            ...
            <EditorTooltip content="Text Color">
                <button
                    ...
                    className={cn(
                        ...
                        "hover:bg-(--color-muted) focus-visible:ring-1 focus-visible:ring-(--color-ring) focus-visible:outline-none",
                        open && "bg-(--color-muted)"
                    )}
                >
                    <div className="relative flex flex-col items-center">
                        ...
                        <div
                            ...
                            style={{
                                backgroundColor:
                                    currentColor || "var(--color-foreground)",
                            }}
                        />
                    </div>
                </button>
            ...
            {open && (
                <>
                    <div
                        ...
                        onMouseDown={() => setOpen(false)}
                    />
                    <div className="absolute top-full left-0 z-50 mt-1 w-44 rounded-lg border border-(--color-border) bg-(--color-background) p-2.5 shadow-lg">
                        <p className="mb-2 text-[10px] font-medium tracking-wider text-(--color-muted-foreground) uppercase">
                            Text Color
                        </p>
            ...
            {open && (
                <>
                    <div
                        ...
                        onMouseDown={() => setOpen(false)}
                    />
                    <div className="absolute top-full left-0 z-50 mt-1 rounded-lg border border-[var(--color-border)] bg-[var(--color-background)] p-3 shadow-lg">
                        <p className="mb-2 text-[10px] font-medium tracking-wider text-[var(--color-muted-foreground)] uppercase">
                            {hovered.rows > 0
                                                ...
                                                <button
                                                    ...
                                                    className={cn(
                                                        ...
                                                        rowIdx < hovered.rows &&
                                                            ...
                                                            : "border-[var(--color-border)] bg-[var(--color-muted)] hover:bg-[var(--color-border)]"
                                                    )}
                                                />
                                            )
                                        )}
...
export function EditorToolbar({
    ...
    return (
        <>
            <div
                className={cn(
                    "flex flex-wrap items-center gap-0.5 gap-y-1 border-b border-[var(--color-border)] p-2",
                    "sticky top-0 z-10 bg-[var(--color-background)]"
                )}
                role="toolbar"
                aria-label="Editor toolbar"
            >
                {/* Semua kontrol toolbar — di-disable saat HTML mode */}
                <div
                    className={cn(
                        "flex flex-1 flex-wrap items-center gap-0.5 gap-y-1",
                ...
                {/* Tombol HTML di LUAR div disabled */}
                {showHtmlToggle && (
                    <EditorTooltip
                        content={isHtmlMode ? "Rich Text Mode" : "HTML Source"}
                    >
                        <button
                            type="button"
                            onMouseDown={(e) => {
...
function ToolbarDivider() {
    return (
        <Separator
            ...
            className="mx-0.5 h-5 bg-[var(--color-border)]"
        />
    )
}
